...
import com.laminatimes.entity.User;
import com.laminatimes.entity.UserRole;
import com.laminatimes.user.reg.UserRegRequest;
import com.laminatimes.repository.RoleRepository;
import com.laminatimes.repository.UserRepository;
import com.laminatimes.repository.UserRoleRepository;
import com.laminatimes.util.RoleEnum;
...
//			userRoleRepo.save(usrRole);
	...
	private User setRole(UserRegRequest userReg, com.laminatimes.entity.User user) {
