package com.laminatimes.admin.model.user.registration.request;
...
public class UserRegRequest {
	...
	public String toString() {
		return "UserRegRequest [userName=" + userName + ", empNumber=" + empNumber + ", aboutUser=" + aboutUser
				+ ", city=" + city + ", clientName=" + clientName + ", password=" + password + ", country=" + country
				+ ", firstName=" + firstName + ", homePhoneNumber=" + homePhoneNumber + ", insuranceNumber="
				...
				+ ", position=" + position + ", gendar=" + gender + ", birthDay=" + birthDay + ", activ=" + active
				+ "]";
	}
